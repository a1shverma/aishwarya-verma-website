    ...
    >
      ...
      >
        ...
        <Stack direction='row' spacing={6} ml='auto' mr={{ base: `auto`, md: 5 }}>
          <SocialIcons label='GitHub' href='https://github.com/a1shverma/'>
            <FaGithub />
          </SocialIcons>
          <SocialIcons label='LinkedIn' href='https://www.linkedin.com/in/a1shverma/'>
            <FaLinkedin />
          </SocialIcons>

          <SocialIcons label='Instagram' href='https://www.instagram.com/a1shverma/'>
            <FaInstagram />
          </SocialIcons>
        </Stack>
      </SimpleGrid>
